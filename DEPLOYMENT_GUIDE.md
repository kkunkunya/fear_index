...
- **定时汇报** - 每日早中晚三次汇报（北京时间08:00/12:00/20:00）
...
| `TELEGRAM_CHAT_ID` | `5468993947` | 接收消息的Chat ID |
...
| **每日 00:00 UTC** | scheduled | 早报（北京08:00） |
| **每日 04:00 UTC** | scheduled | 午报（北京12:00） |
| **每日 12:00 UTC** | scheduled | 晚报（北京20:00） |
